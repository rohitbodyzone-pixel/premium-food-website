...
async function main() {
  ...
  const featureConfigs = [
    ...
    { key: 'google_maps_enabled', value: 'true', description: 'Google Maps display and address geocoding toggle' },
    { key: 'google_places_enabled', value: 'true', description: 'Google Places API (New) nearby amenities toggle' },
    { key: 'property_insights_enabled', value: 'true', description: 'Master toggle for Trade Me-style Property Insights' },
    { key: 'property_value_enabled', value: 'true', description: 'Commercial property valuation estimate toggle' },
    { key: 'rent_estimate_enabled', value: 'true', description: 'Weekly rent estimate toggle (MBIE bond stats)' },
    { key: 'sales_history_enabled', value: 'true', description: 'Property historical sales timeline toggle' },
    { key: 'nearby_sales_enabled', value: 'true', description: 'Recent comparable nearby settled sales toggle' },
    { key: 'school_information_enabled', value: 'true', description: 'Authoritative MoE school directory information toggle' },
    { key: 'school_zones_enabled', value: 'true', description: 'MoE official enrolment scheme zone polygon overlay toggle' },
    { key: 'council_valuation_enabled', value: 'true', description: 'Council Rating Valuations (CV, LV, IV) toggle' },
    { key: 'legal_property_details_enabled', value: 'true', description: 'LINZ primary parcels and title details toggle' },
    { key: 'property_hazards_enabled', value: 'true', description: 'Council GIS natural hazard overlays toggle' },
  ];
  ...
  if (sarahUser?.expertProfile) {
    ...
    const p1Data = {
      ...
      latitude: -36.845,
      longitude: 174.745,
      legalDescription: 'Lot 14 Deposited Plan 18452',
      titleReference: 'NA48B/112',
      estateType: 'Fee Simple (Freehold)',
      councilName: 'Auckland Council',
      districtZoning: 'Residential - Single House Zone',
      capitalValueMinorUnits: 275000000,
      landValueMinorUnits: 185000000,
      improvementsValueMinorUnits: 90000000,
      valuationDate: '2024-07-01',
      valuationSource: 'Auckland Council Rating Valuation',
      estimatedValueMinorUnits: 285000000,
      estimatedLowerMinorUnits: 268000000,
      estimatedUpperMinorUnits: 302000000,
      estimateConfidence: 'HIGH',
      estimateDate: 'September 2026',
      estimateSource: 'CoreLogic NZ Automated Valuation Model (AVM)',
      rentWeeklyEstimatedMinorUnits: 135000,
      rentWeeklyLowerMinorUnits: 125000,
      rentWeeklyUpperMinorUnits: 145000,
      rentEstimateDate: 'September 2026',
      rentEstimateSource: 'Tenancy Services NZ & Market Rental Index',
    ...
    await prisma.propertySalesHistory.deleteMany({ where: { propertyId: p1.id } });
    await prisma.propertySalesHistory.createMany({
      data: [
        { propertyId: p1.id, saleDate: new Date('2021-04-12'), priceMinorUnits: 242000000, saleType: 'Arms-length sale' },
        { propertyId: p1.id, saleDate: new Date('2016-09-28'), priceMinorUnits: 175000000, saleType: 'Arms-length sale' },
        { propertyId: p1.id, saleDate: new Date('2008-03-15'), priceMinorUnits: 98000000, saleType: 'Arms-length sale' },
      ],
    });
    ...
    const p2Data = {
      ...
      latitude: -41.291,
      longitude: 174.793,
      legalDescription: 'Unit 42 and Accessory Unit 1-2 Deposited Plan 31920',
      titleReference: 'WN34D/882',
      estateType: 'Stratum in Freehold (Unit Title)',
      councilName: 'Wellington City Council',
      districtZoning: 'Inner Residential / High Density',
      capitalValueMinorUnits: 190000000,
      landValueMinorUnits: 75000000,
      improvementsValueMinorUnits: 115000000,
      valuationDate: '2024-09-01',
      valuationSource: 'Wellington City Council Rating Valuation',
      estimatedValueMinorUnits: 195000000,
      estimatedLowerMinorUnits: 182000000,
      estimatedUpperMinorUnits: 208000000,
      estimateConfidence: 'MEDIUM',
      estimateDate: 'September 2026',
      estimateSource: 'QV NZ Automated Valuation Model',
      rentWeeklyEstimatedMinorUnits: 98000,
      rentWeeklyLowerMinorUnits: 90000,
      rentWeeklyUpperMinorUnits: 106000,
      rentEstimateDate: 'September 2026',
      rentEstimateSource: 'Tenancy Services NZ',
      images: JSON.stringify([
    ...
    await prisma.propertySalesHistory.deleteMany({ where: { propertyId: p2.id } });
    await prisma.propertySalesHistory.createMany({
      data: [
        { propertyId: p2.id, saleDate: new Date('2022-02-18'), priceMinorUnits: 180000000, saleType: 'Arms-length sale' },
        { propertyId: p2.id, saleDate: new Date('2017-06-10'), priceMinorUnits: 134000000, saleType: 'Arms-length sale' },
      ],
    });
    ...
    const p3Data = {
      ...
      latitude: -43.518,
      longitude: 172.618,
      legalDescription: 'Lot 2 Deposited Plan 52891',
      titleReference: 'CB89A/410',
      estateType: 'Fee Simple (Freehold)',
      councilName: 'Christchurch City Council',
      districtZoning: 'Residential Medium Density (RMD)',
      capitalValueMinorUnits: 88000000,
      landValueMinorUnits: 42000000,
      improvementsValueMinorUnits: 46000000,
      valuationDate: '2025-08-01',
      valuationSource: 'Christchurch City Council Rating Valuation',
      estimatedValueMinorUnits: 89500000,
      estimatedLowerMinorUnits: 84000000,
      estimatedUpperMinorUnits: 95000000,
      estimateConfidence: 'HIGH',
      estimateDate: 'September 2026',
      estimateSource: 'CoreLogic NZ Automated Valuation Model (AVM)',
      rentWeeklyEstimatedMinorUnits: 75000,
      rentWeeklyLowerMinorUnits: 70000,
      rentWeeklyUpperMinorUnits: 80000,
      rentEstimateDate: 'September 2026',
      rentEstimateSource: 'Tenancy Services NZ & Market Rental Index',
      images: JSON.stringify([
    ...
    await prisma.propertySalesHistory.deleteMany({ where: { propertyId: p3.id } });
    await prisma.propertySalesHistory.createMany({
      data: [
        { propertyId: p3.id, saleDate: new Date('2023-11-05'), priceMinorUnits: 85000000, saleType: 'Arms-length sale' },
        { propertyId: p3.id, saleDate: new Date('2019-08-14'), priceMinorUnits: 62000000, saleType: 'Arms-length sale' },
      ],
    });
